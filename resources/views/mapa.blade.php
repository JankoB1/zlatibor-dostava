    ...
    <script>
        ...
        function initMap() {
            ...
            const map = new google.maps.Map(document.getElementById("map"), {
                zoom: 16,
                center: { lat: 43.72624696264375, lng: 19.700576201668294 },
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDrJ7WGgyGnxO8wu3NEFavqoTHEv0sdlXs&libraries=places&callback=initMap&channel=GMPSB_addressselection_v1_cABC" async defer></script>
</body>
</html>
