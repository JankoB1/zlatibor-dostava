            ...
            <div class="card-body">
                <form id="forma-registracija" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-12">
                            <input id="adresa" type="text" class="form-control @error('adresa') is-invalid @enderror"
                                   name="adresa" value="{{ old('adresa') }}" required autocomplete="adresa" autofocus>
                    ...
                    <div class="form-group row">
                        <label for="apartman" class="col-md-12 col-form-label text-md-left">{{ __('Apartman') }}</label>
                    ...
                    <div class="form-group row">
                        <label for="telefon" class="col-md-12 col-form-label text-md-left">{{ __('Telefon') }}</label>

                        <div class="col-md-12">
                            <input id="telefon" type="tel" class="form-control @error('telefon') is-invalid @enderror"
